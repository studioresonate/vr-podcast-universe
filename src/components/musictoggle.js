  ...
  init: function () {
    ...
    function vrMusicToggle() {
      ...
      if (sun.hasAttribute('music')) {
        ...
        toggle.setAttribute('animation', 'property: position; to: 1.3 0 -0.002; dur: 200; easing: linear; loop: false')
        ...
        toggle.setAttribute('animation', 'property: position; to: -0.2 0 -0.002; dur: 200; easing: linear; loop: false')
