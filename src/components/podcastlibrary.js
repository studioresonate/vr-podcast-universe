// AFRAME.registerComponent('podcastlibrary', {
//   schema: {},
//   init: function () {
//     // Random position and offset for Sun
...
//     const endpoint = "https://graphql.contentful.com/content/v1/spaces/" + "ydi6vzm9xood";
...
//       method: "POST",
//       headers: {
//         Authorization: "Bearer " + "7xtBxl2gUUxmAT_agovU0N7cp4Xnm10fgxI1h5x9N3U",
...
//       const lorem = 'Nulla consequat eiusmod sit aliquip Lorem fugiat duis tempor consectetur aute labore enim fugiat. Et veniam et aute dolore elit pariatur dolore esse reprehenderit ullamco culpa laborum consequat non dolore. Do voluptate quis reprehenderit culpa labore elit ipsum eu proident nulla ex. Nulla in eu eu dolore consectetur quis aliqua. Ipsum velit veniam commodo incididunt. Ex dolor amet ex magna amet proident. Ea dolore do labore eiusmod laborum ipsum ad irure.'
...
//           podcastmodal.setAttribute('position', '0 2 -5')
...
//           podcast.videoPreview ? setAttributes(modaldesc, { 'value': lorem, 'position': '3.93 1.18 0', 'rotation': '0 -16 0', 'width': '4' })
//             : setAttributes(modaldesc, { 'value': lorem, 'position': '-2 1.42 0', 'width': '6.5', 'rotation': '0 0 0' })
